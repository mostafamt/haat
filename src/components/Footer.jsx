    ...
    <footer className="bg-gray-800 text-white py-8 px-4 text-center" dir="rtl">
      ...
      <div className="flex justify-center gap-3 mb-4">
        <a
          ...
          className="flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white font-bold px-4 py-2 rounded-full text-sm transition-colors"
        >
        ...
        <a
          href={tel}
          className="flex items-center gap-2 bg-gray-600 hover:bg-gray-500 text-white font-bold px-4 py-2 rounded-full text-sm transition-colors"
        >
