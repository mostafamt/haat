...
const STATUS_MAP = { pending: 'قيد التجهيز ⏳', done: 'تم التسليم ✅' };
    ...
    <div className="min-h-screen bg-gray-100 p-4" dir="rtl">
      <div className="max-w-2xl mx-auto">
        <div className="bg-red-600 text-white text-center py-4 rounded-2xl mb-6">
          <h1 className="text-2xl font-black">لوحة التحكم — هات 🍗</h1>
          <p className="text-sm opacity-80 mt-1">{orders.length} طلب إجمالي</p>
        </div>

        {loading && <p className="text-center text-gray-500 py-10">جاري التحميل...</p>}

        {!loading && orders.length === 0 && (
          <p className="text-center text-gray-500 py-10">لا توجد طلبات بعد</p>
        )}
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <p className="text-red-600 font-black text-lg mt-2">{order.total} جنيه</p>
                </div>
              </div>
